...
void update_position_gpu_mix(float3* positionsGPU, float3* velocitiesGPU, float3* accelerationsGPU, float* massesGPU, int n_particles)
{
...
::step()
{
	update_position_gpu_mix(positionsGPU, velocitiesGPU, accelerationsGPU, massesGPU, n_particles);
